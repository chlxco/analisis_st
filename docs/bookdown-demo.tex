...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Test de autocorrelacion total y parcial}
\FunctionTok{tsdisplay}\NormalTok{(modelo\_ts,}\AttributeTok{lag.max =} \DecValTok{20}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#descomposicion \textless{}{-} decompose(indice.ts)}
